...
//  }
  ...
  $sub_array[] = '<div class="update" data-id="'.$row["intClientId"].'" 	data-column="strClientLastName">' . $row["strClientLastName"] . '</div>';
	 ...
	 $sub_array[] =
	 	'
		<a style="border: 1px solid; color: white; background: #6C757D; border-radius: 4px; text-decoration: none; padding: .2rem .75rem" class=" ml-2 btn_viewrec" data-id="'.$row["intClientId"].'" href="donorrecords-tab-viewinfo.php?id='.$row["intClientId"].'">View</a>
	 	'; //<button type="button" name="delete" class="btn btn-danger fa fa-trash btn-sm btnDeleteCultureMedia" id="'.$row["intClientId"].'"></button>

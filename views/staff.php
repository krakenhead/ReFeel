          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 p-0">
              <div class="content-container" style="padding-bottom: 4rem">
                <h4>Current Staff</h4>
                <table id="tblStaff" class="table table-striped table-bordered text-center">
                  <thead>
                    <tr>
                      <th>First Name</th>
                      <th>Middle Name</th>
                ...
                <button type="button" class="btn btn-outline-danger float-right mt-3" data-toggle="modal" data-target="#modalSignUp"><i class="fas fa-user-plus"></i> Add Staff</button>
              </div>
            </div>
          </div>
        </div>
